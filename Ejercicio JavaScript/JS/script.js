document.getElementById("Formulario").addEventListener("submit", function(event) {
    ...
    if (nombre === "") {
        document.getElementById("nombre").textContent = "El nombre es obligatorio.";
        hayError = true;
    }

    // Validación de Apellidos
    if (apellidos === "") {
        document.getElementById("apellidos").textContent = "Los apellidos son obligatorios.";
        hayError = true;
    }

    // Validación de Edad
    if (isNaN(edad) || edad <= 0) {
        document.getElementById("edad").textContent = "La edad debe ser un número positivo mayor a 0.";
        hayError = true;
    }
